...
void main() {
    ...
    home: BlocProvider(
      ...
      child: const Scaffold(
        body: ReportProblemButton(
          target: QuestionFeedbackTarget.question(7001),
  ...
  testWidgets('жалоба из диалога уходит в чат с разработчиком', (tester) async {
    ...
    expect(chat.sent.single.body, contains('ответ неверный'));
    expect(chat.sent.single.body, startsWith('Report · explanation'));
    expect(chat.sent.single.questionIds, [7001]);
